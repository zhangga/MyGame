...
class TweenLiteUtil {
    ...
    // }
    //物品掉落
    public static dropbodyFly1(body: egret.DisplayObject, callFunc: Function, callObj, dropPoint: egret.Point): void {
        var currY: number = body.y;
        var distance: number = Math.floor(30 + Math.random() * 5);
        var _flyHigh: number = currY - distance;
        var _tween1 = egret.Tween.get(body);
        var time1: number = distance * 3;
        var time2: number = 0;
        var time3: number = 700;
    ...
    //直接掉落
    public static dropbodyFly2(body: egret.DisplayObject, callFunc: Function, callObj, dropPoint: egret.Point): void {
        var currY: number = body.y;
        var _tween1 = egret.Tween.get(body);
        var time2: number = 0;
        var time3: number = 700;
    ...
    /**两点直线运动**/
    public static beelineTween(body: egret.DisplayObject, callFunc: Function, callObj, targetPoint: egret.Point, ease = egret.Ease.circOut, msec: number = 600): void {
        var _tween2 = egret.Tween.get(body);
    ...
    /**获得奖励提示动画**/
    public static awardTween(body: egret.DisplayObject, callFunc: Function, callObj, targetPoint: egret.Point): void {
    ...
    /**鱼等级提升动画**/
    public static secOutputAddTween(body: egret.DisplayObject, callFunc: Function, callObj, targetPoint: egret.Point): void {
    ...
    /**转盘转动动画**/
    public static TurnplateEffectTween(target: egret.DisplayObject, rotation: number, callFunc: Function, callObj): void {
